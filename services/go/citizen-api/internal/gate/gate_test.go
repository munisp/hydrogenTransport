...
// citizen-api gates the arrivals routes behind the passenger-pwa module.
const (
	moduleUnderTest = "passenger-pwa"
	routeUnderTest  = "/v1/passenger/arrivals"
)
...
func toggleServer(t *testing.T, enabled bool) *httptest.Server {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(map[string]any{
			"module": module, "enabled": enabled, "domain": "citizen",
		})
	}))
	t.Cleanup(srv.Close)
	return srv
