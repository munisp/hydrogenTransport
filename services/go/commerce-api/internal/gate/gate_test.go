...
// commerce-api gates the payment routes behind the fare-payments module.
const (
	moduleUnderTest = "fare-payments"
	routeUnderTest  = "/v1/payments"
)
...
func toggleServer(t *testing.T, enabled bool) *httptest.Server {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(map[string]any{
			"module": module, "enabled": enabled, "domain": "commerce",
		})
	}))
	t.Cleanup(srv.Close)
	return srv
